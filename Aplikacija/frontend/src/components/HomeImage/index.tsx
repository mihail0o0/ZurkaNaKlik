...
const HomeImage= ()=>{
    ...
    return(
        ...
        <div className={style.DoleDiv}>{user ?   <div className={style.Dugmad}>
          ...
          </div> : <div className={style.PrijavaPretrazi}>
                      <MojButton text="Prijava" backgroundColor="white" color="black" onClick={()=>{}} paddingX="40px" paddingY="15px" />
                      <MojButton text="Pretrazi" backgroundColor="white" color="black"onClick={()=>{}} paddingX="40px"paddingY="15px" />
            </div>}
